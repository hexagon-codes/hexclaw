...
func New(cfg config.LLMConfig) (*Router, error) {
	r := &Router{
...
func (r *Router) createProvider(name string, pc config.LLMProviderConfig) hexagon.Provider {
...
func (r *Router) Get(name string) (hexagon.Provider, bool) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *Router) Default() hexagon.Provider {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *Router) Route(_ context.Context) (hexagon.Provider, string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *Router) Fallback(exclude string) (hexagon.Provider, string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
